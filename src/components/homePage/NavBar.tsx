...
const pages = ['Browse', 'Study Tables', 'Meeting Rooms', 'My Bookings'];
const settings = ['My Profile', 'My Bookings', 'Settings', 'Logout'];
            ...
            <Container maxWidth="xl">
                <Toolbar disableGutters sx={{height: 64}}>
                    ...
                    >
                        ...
                        >
                            <ChairOutlinedIcon sx={{color: '#fff', fontSize: 18}}/>
                        </Box>
                        <Typography
                            sx={{
                                ...
                                <MenuItem
                                    ...
                                    sx={{
                                        ...
                                        backgroundColor: activePage === page
                                            ? `rgba(201, 98, 47, 0.18)` : 'transparent',
                    ...
                    >
                        ...
                        >
                            <ChairOutlinedIcon sx={{color: '#fff', fontSize: 16}}/>
                        </Box>
                        <Typography
                            sx={{
                                fontFamily: '"DM Serif Display", Georgia, serif',
                    ...
                    {/* ── Nav links (desktop) ── */}
                    <Box sx={{flexGrow: 1, display: {xs: 'none', md: 'flex'}, gap: '2px'}}>
                        {pages.map((page) => (
                            <Button
                                key={page}
                                onClick={() => {
