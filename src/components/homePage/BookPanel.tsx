...
export const BookPanel: React.FC<BookPanelProps> = ({
    ...
    return (
        <Box sx={{width: 360, p: 3, backgroundColor: colors.cream, height: "100%", overflowY: "auto"}}>
            ...
            <Box sx={{display: "flex", flexWrap: "wrap", gap: 1, mb: 2}}>
                {[
                    {icon: <PlaceOutlinedIcon sx={{fontSize: 13}}/>, label: location},
                    {icon: <PlaceOutlinedIcon sx={{fontSize: 13}}/>, label: `Up to ${capacity}`},
                    {icon: <AttachMoneyIcon sx={{fontSize: 13}}/>, label: `$${price}/hr`},
            ...
            >
                <Typography sx={{fontSize: 13, color: colors.stone}}>Estimated total</Typography>
                <Typography sx={{fontSize: 16, fontWeight: 600, color: colors.ink}}>${price}/hr</Typography>
            </Box>
